    ...
    export namespace Guestfs {
        ...
        class AddDriveScratch extends GObject.Object {
            ...
            emit<K extends keyof AddDriveScratch.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<AddDriveScratch.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
         ...
         */
        class BTRFSScrubFull extends GObject.Object {
            static $gtype: GObject.GType<BTRFSScrubFull>;
             ...
             * @internal
             */
            $signals: BTRFSScrubFull.SignalSignatures;

            // Constructors

            constructor(properties?: Partial<BTRFSScrubFull.ConstructorProps>, ...args: any[]);

            _init(...args: any[]): void;

            static ['new'](): BTRFSScrubFull;

            // Signals

            connect<K extends keyof BTRFSScrubFull.SignalSignatures>(
                signal: K,
                callback: GObject.SignalCallback<this, BTRFSScrubFull.SignalSignatures[K]>,
            ): number;
            connect(signal: string, callback: (...args: any[]) => any): number;
            connect_after<K extends keyof BTRFSScrubFull.SignalSignatures>(
                signal: K,
                callback: GObject.SignalCallback<this, BTRFSScrubFull.SignalSignatures[K]>,
            ): number;
            connect_after(signal: string, callback: (...args: any[]) => any): number;
            emit<K extends keyof BTRFSScrubFull.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<BTRFSScrubFull.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        }
        ...
        class CompressDeviceOut extends GObject.Object {
            ...
            emit<K extends keyof CompressDeviceOut.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<CompressDeviceOut.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class CopyDeviceToDevice extends GObject.Object {
            ...
            emit<K extends keyof CopyDeviceToDevice.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<CopyDeviceToDevice.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class CopyDeviceToFile extends GObject.Object {
            ...
            emit<K extends keyof CopyDeviceToFile.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<CopyDeviceToFile.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class CopyFileToDevice extends GObject.Object {
            ...
            emit<K extends keyof CopyFileToDevice.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<CopyFileToDevice.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        namespace CryptsetupOpen {
            // Signal signatures
            interface SignalSignatures extends GObject.Object.SignalSignatures {
                'notify::cipher': (pspec: GObject.ParamSpec) => void;
                'notify::crypttype': (pspec: GObject.ParamSpec) => void;
                'notify::readonly': (pspec: GObject.ParamSpec) => void;
            }
        ...
        class CryptsetupOpen extends GObject.Object {
             ...
             * @internal
             */
            $signals: CryptsetupOpen.SignalSignatures;
            ...
            connect<K extends keyof CryptsetupOpen.SignalSignatures>(
                signal: K,
                callback: GObject.SignalCallback<this, CryptsetupOpen.SignalSignatures[K]>,
            ): number;
            connect(signal: string, callback: (...args: any[]) => any): number;
            connect_after<K extends keyof CryptsetupOpen.SignalSignatures>(
                signal: K,
                callback: GObject.SignalCallback<this, CryptsetupOpen.SignalSignatures[K]>,
            ): number;
            connect_after(signal: string, callback: (...args: any[]) => any): number;
            emit<K extends keyof CryptsetupOpen.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<CryptsetupOpen.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        }
        ...
        namespace E2fsck {
            ...
            interface SignalSignatures extends GObject.Object.SignalSignatures {
                ...
                'notify::forceno': (pspec: GObject.ParamSpec) => void;
            }
        ...
        class E2fsck extends GObject.Object {
             ...
             * A boolean.
             */
            get forceno(): Tristate;
            set forceno(val: Tristate);
        ...
        class Session extends GObject.Object {
             ...
             * See also guestfs_session_feature_available().
             * @param path
             * @param optargs a GuestfsBTRFSScrubFull containing optional arguments
             * @returns true on success, false on error
             */
            btrfs_scrub_full(path: string, optargs?: BTRFSScrubFull | null): boolean;
            /**
             ...
             * @returns true on success, false on error
             */
            command_out(_arguments: string[], output: string, cancellable?: Gio.Cancellable | null): boolean;
            /**
             ...
             * @returns the returned string, or NULL on error
             */
            findfs_partlabel(label: string): string;
            /**
             ...
             * @returns the returned string, or NULL on error
             */
            findfs_partuuid(uuid: string): string;
            /**
            ...
            internal_test_63_optargs(
                optargs?: InternalTest63Optargs | null,
                cancellable?: Gio.Cancellable | null,
            ): boolean;
            /**
             * internal test function - do not use
             ...
             * @returns true on success, false on error
             */
            sh_out(command: string, output: string): boolean;
            /**
        ...
        type BTRFSScrubFullClass = typeof BTRFSScrubFull;
        abstract class BTRFSScrubFullPrivate {
            static $gtype: GObject.GType<BTRFSScrubFullPrivate>;
